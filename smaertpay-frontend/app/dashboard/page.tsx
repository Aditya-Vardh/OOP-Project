...
import { generateRandomBalance, generateRandomTransactions, generateRandomCardNumber, generateRandomUserName } from "@/lib/randomizer"
...
export default function DashboardPage() {
  ...
  const [cardNumber, setCardNumber] = useState("8143 5839 1100 4829")
  const [transactions, setTransactions] = useState(generateRandomTransactions())
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Balance Card */}
      <BalanceCard balance={balance} cardNumber={cardNumber} userName={user?.name} />
            ...
            <div className="space-y-4">
              {transactions.map((transaction, index) => (
                <div key={index} className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                  ...
                  <p className={`font-semibold ${transaction.amount > 0 ? 'text-green-600' : 'text-destructive'}`}>
